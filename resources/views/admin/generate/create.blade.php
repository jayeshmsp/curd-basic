		...
		<div class="row">
			<div class="col-md-12">
				<div class="white-box">
					...
					<div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
						<label class="col-sm-2 control-label">Is Model</label>
						<div class="col-sm-3">
							{!! Form::checkbox('is_model', 1, true, array('class' => '')) !!}
							{!! $errors->first('is_model', '<span class="help-block">:message</span>') !!}
						</div>
...
<table>
    <tbody class="hide" id="template-source">
        <tr class="formRow row1" id="unique_Row-key">
            <td>
            	{!! Form::text("row[key][field]",old('field'),array('class'=>'field','id'=>'field-key','style'=>'width:100px')) !!}
            </td>
            <td>
            	{!! Form::text("row[key][display_name]",old('display_name'),array('class'=>'display_name','id'=>'display_name-key','style'=>'width:100px')) !!}
            </td>
            <td>
            ...
            <td>
            	 ...
            	 {!! Form::text('row[key][validation][]') !!} <strong>Custom</strong> <br/>
            </td>
            <td>
